...
import { createInvalidParamErrorMessage, createHttpErrorMessage } from './helpers.js';
...
describe('fetchListOfPhotos', () => {
  ...
  it('should call the fetch API with the correct URL', () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith(`${PUBLIC_API_URL}/photos?_page=1&_limit=20`);
  });
...
describe('fetchListOfAlbums', () => {
  ...
  it('should call the fetch API with the correct URL', () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith(`${PUBLIC_API_URL}/albums?_page=1&_limit=20`);
  });
...
describe('fetchPhotoInfo', () => {
  ...
  it('should throw an error if the photoId parameter is invalid', () => {
    expect(() => fetchUserInfo(undefined)).toThrowError(createInvalidParamErrorMessage(undefined));
  });
...
describe('fetchAlbumInfo', () => {
  ...
  it('should throw an error if the photoId parameter is invalid', () => {
    expect(() => fetchAlbumInfo(undefined)).toThrowError(createInvalidParamErrorMessage(undefined));
  });
